...
API_KEY = "7379e70885391073b5d1dcf9dd53438da4764fb0"
...
class CPIData(object):
    ...
    def load_from_file(self, fp):
        ...
        for line in fp:
            ...
            # we can skip ahead.
            if not line.startswith("DATE ") and data_search:
                # -=DEBUGGING=-
                print(line)
                # -=DEBUGGING=-
                continue
            ...
            # to make the data easier to use. (.rstrip() redundant?!)
...
def main():
    ...
    if os.path.exists(opts.cpi_file):
        with open(opts.cpi_file, 'r', encoding='cp850') as fp:
            print(str(fp))
